...
{
  return jni::ToJavaArray(env, {kKmzExtension, kKmlExtension, kKmbExtension, kGpxExtension, kGeoJsonExtension, kJsonExtension}, [](JNIEnv * env, std::string_view ext)
  {
    return jni::ToJavaString(env, ext);
  });
}
